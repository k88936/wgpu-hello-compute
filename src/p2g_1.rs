...
impl OverrideConstants {
    pub fn constants(&self) -> Vec<(&'static str, f64)> {
        let entries = vec![("fixed_point_multiplier", self.fixed_point_multiplier as f64)];
        entries
    }
}
pub mod bind_groups {
...
pub mod compute {
    pub const P2G_1_WORKGROUP_SIZE: [u32; 3] = [64, 1, 1];
    pub fn create_p2g_1_pipeline(device: &wgpu::Device) -> wgpu::ComputePipeline {
        let module = super::create_shader_module(device);
        let layout = super::create_pipeline_layout(device);
        device.create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
            label: Some("Compute Pipeline p2g_1"),
            layout: Some(&layout),
            module: &module,
            entry_point: Some("p2g_1"),
            compilation_options: Default::default(),
            cache: Default::default(),
        })
    }
}
pub const ENTRY_P2G_1: &str = "p2g_1";
