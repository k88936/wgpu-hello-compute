...
const _: () = assert!(
    std::mem::size_of::<RenderUniforms>() == 272,
    "size of RenderUniforms does not match WGSL"
);
const _: () = assert!(
    std::mem::offset_of!(RenderUniforms, inv_projection_matrix) == 0,
    "offset of RenderUniforms.inv_projection_matrix does not match WGSL"
);
const _: () = assert!(
    std::mem::offset_of!(RenderUniforms, projection_matrix) == 64,
    "offset of RenderUniforms.projection_matrix does not match WGSL"
);
const _: () = assert!(
    std::mem::offset_of!(RenderUniforms, view_matrix) == 128,
    "offset of RenderUniforms.view_matrix does not match WGSL"
);
const _: () = assert!(
    std::mem::offset_of!(RenderUniforms, inv_view_matrix) == 192,
    "offset of RenderUniforms.inv_view_matrix does not match WGSL"
);
const _: () = assert!(
    std::mem::offset_of!(RenderUniforms, texel_size) == 256,
    "offset of RenderUniforms.texel_size does not match WGSL"
);
const _: () = assert!(
    std::mem::offset_of!(RenderUniforms, sphere_size) == 264,
    "offset of RenderUniforms.sphere_size does not match WGSL"
);
const _: () = assert!(
    std::mem::offset_of!(RenderUniforms, _pad) == 268,
    "offset of RenderUniforms._pad does not match WGSL"
);
pub mod types {
    #[repr(C)]
    #[derive(
    ...
    const _: () = assert!(
        std::mem::size_of::<PosVel>() == 32,
        "size of PosVel does not match WGSL"
    );
    const _: () = assert!(
        std::mem::offset_of!(PosVel, position) == 0,
        "offset of PosVel.position does not match WGSL"
    );
    const _: () = assert!(
        std::mem::offset_of!(PosVel, density) == 12,
        "offset of PosVel.density does not match WGSL"
    );
    const _: () = assert!(
        std::mem::offset_of!(PosVel, v) == 16,
        "offset of PosVel.v does not match WGSL"
    );
    const _: () = assert!(
        std::mem::offset_of!(PosVel, _pad) == 28,
        "offset of PosVel._pad does not match WGSL"
    );
}
